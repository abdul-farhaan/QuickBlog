  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>Capture the chaos. Write the truth. Your digital journal for the unfiltered moments of life. Start typing, and see where your mind takes you.</p>

        <form className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border-gray-300 bg-white rounded-full  overflow-hidden'>
